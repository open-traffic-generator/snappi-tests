...
def test_stats_filter_e2e(api, b2b_raw_config, utils):
    ...
    for column_name in column_names:
        ...
        port_results = api.get_metrics(req).port_metrics
        validate_port_stats_based_on_column_name(port_results, column_name)
    ...
    for metric_name in metric_names:
        ...
        flow_results = api.get_metrics(req).flow_metrics
        validate_flow_stats_based_on_metric_name(flow_results, metric_name)
...
def validate_port_stats_based_on_column_name(port_results, column_name):
    """
...
def validate_flow_stats_based_on_metric_name(flow_results, metric_name):
    """
