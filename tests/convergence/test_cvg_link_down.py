...
def cvg_api():
    api = snappi_convergence.api(location="localhost:11009", ext="ixnetwork")
...
def test_bgp_cp_dp_convergence(utils, cvg_api, bgp_convergence_config):
    """
    5. set convergence config & start traffic
    ...
    bgp_convergence_config.convergence_event = (
        bgp_convergence_config.LINK_UP_DOWN
    )
