...
def test_vxlanv6_b2b_scale(api, utils):
    ...
    2. Create VXLAN connected to each loopback, so total 128 vxlan tunnels.
    3. Create BGP devices in VXLAN and advertise the routes.
    """
    count = 128
    config = api.config()
    ...
    ip1.address, ip2.address = "3000::1", "3000::2"
    ip1.gateway, ip2.gateway = "3000::2", "3000::1"
    ...
    bgp1_peer.peer_address, bgp2_peer.peer_address = "3000::2", "3000::1"
    ...
    for i in range(1, count + 1):
        ...
        d1_l1.eth_name = "e1"
        d1_l1.address = "1000::{}".format(i)

        bgp1_l1 = bgp1_peer.v6_routes.add(name="bgp_l{}".format(i))
        bgp1_l1.addresses.add(address="1000::{}".format(i), prefix=128)

    for i in range(1, count + 1):
        d2_l1 = d2.ipv6_loopbacks.add()
        d2_l1.name = "d2_loopback{}".format(i)
        d2_l1.eth_name = "e2"
        d2_l1.address = "2000::{}".format(i)

        bgp2_l1 = bgp2_peer.v6_routes.add(name="bgp2_l{}".format(i))
        bgp2_l1.addresses.add(address="2000::{}".format(i), prefix=128)
    ...
    for i in range(1, count + 1):
        ...
        vtep.remote_vtep_address = "2000::{}".format(i)
    ...
    for i in range(1, count + 1):
        ...
        vtep.remote_vtep_address = "1000::{}".format(i)
